...
TMForwardList<string> list14;
list14.add(string("Vishal"),&k);
list14.add(string("Aman"),&k);
list14.add(string("Sonu"),&k);
list14.add(string("Golu"),&k);
list14.add(string("Mahesh"),&k);
list14.add(string("Suresh"),&k);
list14.add(string("Rakesh"),&k);

Iterator<string> iterator14=list14.getIterator();
while(iterator14.hasMoreElements())
{
cout<<iterator14.next()<<" ";
}
cout<<endl;
